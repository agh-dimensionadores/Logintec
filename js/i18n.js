...
const LogintecI18n = (() => {
  ...
  const translations = {
    es: {
      ...
      'dim.equipos.cs325.f2': 'Tecnología de cámara para mayor precisión',
      'dim.equipos.cs325.f3': 'Opción con kit de movilidad para operación flexible',
    ...
    en: {
      ...
      'dim.equipos.cs325.f2': 'Camera technology for higher precision',
      'dim.equipos.cs325.f3': 'Mobility kit option for flexible operation',
